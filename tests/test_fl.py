...
class TestCoverageData:
    ...
    def test_get_sbfl_params(self):
        ...
        # Line 1: 1 failed covering, 1 failed not covering, 1 passed covering, 1 passed not covering
        ...
        # Line 2: 1 failed covering, 1 failed not covering, 0 passed covering, 2 passed not covering
    ...
    def test_get_sbfl_params_nonexistent_line(self):
        ...
        data = CoverageData(
            line_coverage={},
            test_outcomes={"test1": True, "test2": False}
        )
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.json', delete=False) as input_file:
            ...
            with tempfile.NamedTemporaryFile(mode='w', suffix='.json', delete=False) as output_file:
                try:
                    ...
                    # All scores should be the same for this case (1 pass, 1 fail both covering)
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.json', delete=False) as input_file:
            ...
            with tempfile.NamedTemporaryFile(mode='w', suffix='.json', delete=False) as output_file:
                try:
                    ...
                    # Line 10 should have highest suspiciousness (only covered by failing test)
                    ...
                    # Line 15 should have lowest suspiciousness (only covered by passing tests)
