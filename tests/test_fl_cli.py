...
class TestFLCLI:
    ...
    def test_fl_command_basic(self):
    ...
    def test_fl_command_custom_files(self):
    ...
    def test_fl_command_custom_formulas(self):
        """Test FL command with custom formulas."""
        coverage_data = {
            "tests": {"passed": ["test1"], "failed": ["test2"]},
            "files": {
                "file.py": {
                    "contexts": {"1": ["test1|run", "test2|run"]}
                }
            }
        }
    ...
    def test_fl_command_with_config(self):
...
"""
    ...
    def test_fl_command_file_not_found(self):
    ...
    def test_fl_command_invalid_json(self):
    ...
    def test_fl_command_verbose(self):
    ...
    def test_fl_command_empty_coverage(self):
    ...
    def test_main_command_shows_fl(self):
    ...
    def test_complete_workflow_simulation(self):
        ...
        realistic_coverage = {
            ...
            "files": {
                "src\\calculator.py": {
                    ...
                    "contexts": {
                        "1": [""],
                        "4": [""],
                        "5": ["tests/test_calc.py::test_add_positive|run", 
                              "tests/test_calc.py::test_add_negative|run"],
                        "7": ["tests/test_calc.py::test_add_positive|run", 
                              "tests/test_calc.py::test_add_negative|run"],
            ...
            "tests": {
                ...
                "failed": ["tests/test_calc.py::test_add_negative", 
